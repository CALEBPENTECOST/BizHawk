...
namespace CPENTECOST.BizHawk.Utility
{
    /// <summary>
    /// A mutual exclusion lock that is compatible with async. Note that this lock is <b>not</b> recursive!
    /// AsyncLock. Based off of this:
    /// https://github.com/StephenCleary/AsyncEx/blob/0aaae920de495040aae9539775e93c7a063854e3/src/Nito.AsyncEx.Coordination/AsyncLock.cs
    /// </summary>
    /// <remarks>
